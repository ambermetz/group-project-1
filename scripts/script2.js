...
function addToCartHandler() {
  ...
  section.innerHTML = `
  <p> $${newProduct.products[0].productPrice} - ${
    newProduct.products[0].productName
  }</p>
      `;
  ...
  totalDiv.innerHTML = `
  <h1>Total<h1>
  <p>Total: $${(newProduct.products[0].productPrice += total)}</p>
  <p>Sales Tax: ${0.06}</p>
  <p>Subtotal: $${newProduct.products[0].productPrice +
    newProduct.products[0].productPrice * 0.06}</p>
  `;
